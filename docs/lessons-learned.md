...
Cross-build lessons captured by the AI Council of Agents. Every infrastructure build must contribute ≥1 entry here. These are applied to Council operating standards.
...
**Context:** Converter (Beast) container recreated; HubSpot integration broke.
...
**Context:** Restoring Scout (Magneto) mem0/A2A toolset config via yaml.dump.
...
**Context:** Scout (Magneto) mem0 tools appeared wired but were empty at runtime.
